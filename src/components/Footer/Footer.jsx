        ...
        <div className="hidden sm:block">
          <div className="flex justify-between items-center py-6 border-t-2 border-gray-400 ">
            <span className="text-sm text-gray-400">
              copyright &copy; 2024 by Amr Alsyed
            </span>
            <div className="flex items-center justify-center gap-4 pb-4">
              <a href="https://www.linkedin.com/in/amr-alsyed/" target="_blank">
                <FaLinkedin className="text-4xl" />
              </a>
              <a href="https://amralsyed.netlify.app/" target="_blank">
