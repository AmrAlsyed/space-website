          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 relative z-10 ">
            {serviceData.map((data, index) => (
              <div
                ...
                key={index}
                className="min-h-[180px] flex flex-col gap-2 justify-center items-center bg-sky-900/60 backdrop-blur-sm text-center text-2xl py-8 px-3 w-full lg:w-[300px] mx-auto rounded-xl"
              >
                {data.icon}
                <h1>{data.title}</h1>
                <p>{data.content}</p>
